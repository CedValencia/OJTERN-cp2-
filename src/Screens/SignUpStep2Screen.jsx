...
const ResponsiveStyles = () => (
  <style>{`
    ...
    * { box-sizing: border-box; }
    ...
    @media (max-width: 480px) {
      .su2-panel { padding: ${space.lg} ${space.md}; border-radius: 20px; }
    }
  ...
  return (
    <>
      ...
      <div className="su2-wrapper">
        {/* Back — matches the outlined pill used on SignUpStep1 */}
      ...
      {showSuccess && (
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ fontFamily: font.ui, fontWeight: 600, fontSize: "1.1rem", color: color.ink, margin: 0, textAlign: "center" }}>
            ...
            <button
              ...
              className="su2-btn"
              style={{ marginTop: "8px", background: color.ink, color: color.onWine }}
            >Ok</button>
          </div>
        </div>
      )}
